...
-- Alternatuvely you can import other files in here, such as
...
local bar_font = "JetBrainsMono:style=Bold:size=15"
-- Define your blocks
...
oxwm.key.bind({ modkey }, "Y", oxwm.set_master_factor(-5))
oxwm.key.bind({ modkey }, "U", oxwm.set_master_factor(5))
...
--oxwm.autostart("xwallpaper --center /home/jeffy/Pictures/Wallpapers/1.png")
oxwm.autostart("rm /tmp/xlivebg.sock")

oxwm.autostart("xlivebg")
--neededoxwm.autostart("dunst")
